(function () {
  ...
  var translations = {
    sr: {
      ...
      'c.s01': 'Minimalno invazivna stomatologija — Pregledi',
      'c.s02': 'Minimalno invazivna i estetska stomatologija',
      'c.s03': 'Protetika',
      'c.s04': 'Hirurgija',
      'c.s05': 'Invisalign — folije za ispravljanje zuba',
      'c.s06': 'Anti-ageing & regenerativna estetska medicina — Botox',
      'c.s07': 'Skinboosters & polinukleotidi',
      'c.s08': 'Medicinski microneedling sa mezoterapijom',
      'c.s09': 'Hijaluronski fileri',
      'c.th.service': 'Usluga',
      'c.th.package': 'Paket',
      'c.th.treatment': 'Tretman',
      'c.th.price': 'Cena',
      'c.free': 'besplatan*',
      'c.eur': '* u dinarskoj protivvrednosti na dan plaćanja po srednjem kursu NBS',
      'c.note': '<strong>Napomena:</strong> Prikazane cene su informativne. Tačna cena se određuje nakon pregleda i konsultacije u zavisnosti od kompleksnosti slučaja. Cene Invisalign paketa su u evrima i plaćaju se u dinarskoj protivvrednosti po <strong>srednjem kursu NBS na dan plaćanja</strong>. Za sve informacije pozovite <a href="tel:+381637178337" style="color:var(--c-accent-dark);font-weight:500">+381 63 71 78 337</a> ili pišite na <a href="mailto:info@maisondental.rs" style="color:var(--c-accent-dark);font-weight:500">info@maisondental.rs</a>.',
      'c.n01': 'Inicijalni pregled (odrasli) — 45 min.',
      'c.n02': 'Redovni pregled (odrasli) — 30 min.',
      'c.n03': 'Inicijalni pregled (deca) — 30 min.',
      'c.n04': 'Redovni pregled (deca)',
      'c.n05': 'Uklanjanje zubnog kamenca',
      'c.n06': 'Premium kompozitni vinir',
      'c.n07': 'Kompozitni edge bonding',
      'c.n08': 'Jednopovršinski estetski ispun (plomba)',
      'c.n09': 'Dvopovršinski estetski ispun (plomba)',
      'c.n10': 'Tropovršinski estetski ispun (plomba)',
      'c.n11': 'Visoko estetski ispun (prednji zub)',
      'c.n12': 'Ispun na mlečnim zubima',
      'c.n13': 'Vađenje mlečnog zuba',
      'c.n14': 'Privremeni ispun (plomba)',
      'c.n15': 'Glasjonomer ispun (plomba)',
      'c.n16': 'Izbeljivanje zuba metodom trejeva',
      'c.n17': 'Urgentna stanja',
      'c.n18': 'Lečenje kanala korena',
      'c.n19': 'Kompleksno lečenje kanala korena / revizija (specijalista)',
      'c.n20': 'Minimalno invazivna adhezivna restauracija: Inlay / Onlay / Overlay',
      'c.n21': 'Bezmetalna keramička (Emax) krunica',
      'c.n22': 'Cirkonija krunica / član mosta',
      'c.n23': 'Vađenje zuba jednostavno',
      'c.n24': 'Vađenje zuba kompleksno',
      'c.n25': 'Vađenje zuba hirurško (specijalista)',
      'c.n26': 'Invisalign konsultacija',
      'c.n27': 'Invisalign Express Package',
      'c.n28': 'Invisalign Lite Package',
      'c.n29': 'Invisalign Moderate Package',
      'c.n30': 'Invisalign Comprehensive Package',
      'c.n31': 'Invisalign First',
      'c.n32': 'Invisalign Teen',
      'c.n33': 'Vivera Retainers × 3',
      'c.n34': 'Tvrda folija za retenciju × 2',
      'c.n35': 'Botox — jedna regija (između obrva)',
      'c.n36': 'Botox — dve regije (obrve + čelo)',
      'c.n37': 'Botox — tri regije (obrve, čelo, oko očiju)',
      'c.n38': 'Lifting obrva botoxom',
      'c.n39': 'Lifting vrata i donjeg lica botoxom',
      'c.n40': 'Full face botox',
      'c.n41': 'Hiperhidroza (terapija prekomernog znojenja)',
      'c.n42': 'Terapija bruksizma (škripanje zubima)',
      'c.n43': 'Profhilo — po tretmanu',
      'c.n44': 'Polinukleotidi oko očiju',
      'c.n45': 'Nuclefill 2ml',
      'c.n46': 'Hemijski piling Obagi',
      'c.n47': 'Mezoglow',
      'c.n48': 'Mezobright',
      'c.n49': 'Mezoyoung',
      'c.n50': 'Exosomi E-50',
      'c.n51': 'Usne — do 1ml',
      'c.n52': 'Jagodice, brada — 1ml',
      'c.n53': 'Balansiranje profila — 2ml',
      'c.n54': 'Balansiranje profila — 3ml',
      'c.n55': '8 Point Lift',
      'c.d01': 'Pregled TMZ, sluzokože, zuba, parodoncijuma; analiza higijene i dijete; pisani plan terapije',
      'c.d02': '* ukoliko je termin zakazan u roku od 6 meseci od prethodnog pregleda',
      'c.d03': 'Pregled okluzije, sluzokože, zuba; analiza higijene i dijete',
      'c.d04': 'Otvaranje zuba, dresing, privremeni ispun uz ordiniranje antibiotika ukoliko je indikovano',
      'c.d05': 'Uklanjanje tvrdih i mekih naslaga, pigmentacija i obuka pravilnoj higijeni sa airflow peskiranjem',
      'c.d06': 'Utvrđivanje kandidature, upoznavanje sa sistemom, pisani plan terapije',
      'c.d07': 'Do 7 folija',
      'c.d08': 'Do 14 folija',
      'c.d09': 'Do 20 folija',
      'c.d10': 'Od 21+ folija',
      'c.d11': 'Za decu u mešovitoj denticiji',
      'c.d12': '2 tretmana preporučena za najbolji efekat',
      'c.d13': 'Polinukleotidi za kožu lica u 5 tačaka',
      'c.d14': 'Hemijski piling, mezoterapijski koktel za hidrataciju i blistavost kože, umirujuća maska — lice i vrat',
      'c.d15': 'Hemijski piling, mezoterapijski koktel za ublažavanje hiperpigmentacije i neujednačenosti, umirujuća maska — lice i vrat',
      'c.d16': 'Hemijski piling, mezoterapijski koktel za podmlađen izgled kože, jedrinu i ublažavanje bora, umirujuća maska — lice i vrat',
      /* CENOVNIK */
